...
const MEETINGS: Entry[] = [
  ...
  {
    id: "m5",
    title: "IS Department: Database Systems Rubric Alignment",
    date: "Tuesday, April 22, 2026",
    time: "10:00 AM to 10:45 AM (PHT)",
    people: ["MC", "KC"],
    extra: 1,
    platform: "Google Meet",
    tag: "IS",
  ...
  {
    id: "m6",
    title: "CS Department: ML Foundations Dataset Review",
    date: "Tuesday, April 22, 2026",
    time: "3:00 PM to 3:45 PM (PHT)",
    people: ["AW", "DV"],
    extra: 3,
    platform: "Zoom",
    tag: "CS",
  ...
  {
    id: "m7",
    title: "IT Department: Cybersecurity Lab Safety Briefing",
    date: "Wednesday, April 23, 2026",
    time: "11:00 AM to 11:30 AM (PHT)",
    people: ["NM", "BR"],
    extra: 5,
    platform: "Google Meet",
    tag: "IT",
  ...
  {
    id: "m8",
    title: "Game Dev: Multiplayer Netcode Sprint Planning",
    date: "Wednesday, April 23, 2026",
    time: "4:00 PM to 5:00 PM (PHT)",
    people: ["KA", "AL", "TN"],
    extra: 4,
    platform: "Zoom",
    tag: "Game Dev",
  ...
  {
    id: "m9",
    title: "Cross-Department: Vault Content Audit",
...
const EVENTS: Entry[] = [
  ...
  {
    id: "e3",
    title: "Game Dev Demo Day: Multiplayer Prototypes",
    date: "Friday, April 25, 2026",
    time: "10:00 AM to 1:00 PM (PHT)",
    people: ["KA", "TN", "SM"],
    extra: 16,
    platform: "Google Meet",
    tag: "Showcase",
  ...
  {
    id: "e4",
    title: "IT Capture the Flag: Cybersecurity Fundamentals",
    date: "Saturday, April 26, 2026",
    time: "9:00 AM to 4:00 PM (PHT)",
    people: ["NM", "PA", "LO"],
    extra: 28,
    platform: "Zoom",
    tag: "Competition",
  ...
  {
    id: "e5",
    title: "CS + IS Joint Workshop: Databases for ML Pipelines",
    date: "Monday, April 28, 2026",
    time: "2:00 PM to 3:30 PM (PHT)",
    people: ["AW", "MC"],
    extra: 9,
    platform: "Google Meet",
    tag: "Workshop",
